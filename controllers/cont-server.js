...
exports.install_cms_2 = (req, domain) => new Promise((resolve, reject) => {
    ...
    ssh.connect({
        ...
        .then(function () {
            ...
            // Command copy cms
            ssh.execCommand('cp -f latest.zip ' + domain.www_root, { cwd: '/var/www/vhosts/nodebuilder.id/' }).then(function (result) {
                ...
                if (result.stderr == '') {
                    ...
                    if (result.stderr == '') {
                        ...
                        // command unzip file cms installer
                        ssh.execCommand('unzip latest.zip', { cwd: domain.www_root }).then(function (result) {
